...
router.post( '/login' , accountValidate.validateLogin , accountController.loginPost );
...
router.post( '/reset-password', authMiddleware.verifyToken, accountValidate.resetPasswordPost, accountController.resetPasswordPost );
